  ...
  return (
    <div className={classes.container} data-aos='zoom-in-up'>
      ...
      <p className={classes.icon}>
        ...
        <a href="https://maps.app.goo.gl/6z1BSQ7BBRk19Pm29"> 22,Tsega Building 5th Floor</a>
      </p>
      <div className={classes.headingContainer}><h>
        Find us 
      </h>
      <hr className={classes.horizontalLine} /></div>
      ...
      <div className={classes.linkContainer}>
        ...
        <a href=''><img src={instagramIcon} alt="instagram Icon"></img></a>
